...
<body style="background-color: #e3f2fd;">
  ...
  <footer class="fixed-bottom bg-dark text-white text-center py-2">
    <p class="mb-0">&copy;//NITHISH S (212223220070)</p>
  </footer>
...
<body class="bg-info">
  ...
  <footer class="bg-dark text-white text-center py-2 mt-5">
    <p>&copy; //NITHISH S (212223220070)</p>
  </footer>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="project 1.jpeg" class="card-img-top" alt="Product 1">
            <div class="card-body">
          ...
          <div class="card">
            <img src="project 2.jpeg" class="card-img-top" alt="Product 2">
            <div class="card-body">
          ...
          <div class="card">
            <img src="project 3.jpeg" class="card-img-top" alt="Product 3">
            <div class="card-body">
...
## OUTPUT:
![alt text](<new/myapp/Screenshot 2024-05-11 182528.png>)
![alt text](<new/myapp/Screenshot 2024-05-11 181613.png>)
